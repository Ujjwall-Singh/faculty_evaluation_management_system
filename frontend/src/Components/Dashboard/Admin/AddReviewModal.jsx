...
const AddReviewModal = ({ faculty, onClose, onAdd }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    setLoading(true);
    try {
      // Prepare review data with both individual fields and combined format for compatibility
      const reviewData = {
        ...formData,
        // Keep individual fields for new format
        branch: formData.branch,
        semester: formData.semester,
        section: formData.section,
        // Also maintain backward compatibility with branchSemester format
